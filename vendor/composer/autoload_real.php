...
class ComposerAutoloaderInit4de79ba14c652e823aac59344b6f5667
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit4de79ba14c652e823aac59344b6f5667::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire4de79ba14c652e823aac59344b6f5667($fileIdentifier, $file);
        }
...
function composerRequire4de79ba14c652e823aac59344b6f5667($fileIdentifier, $file)
{
