...
$data["Period"] = getcsv(getenv("LEDGER_BEGIN"),getenv("LEDGER_END"),getenv("tpath"));
$dataset = "Period";
$tla = gettla($data["Period"]);
$acc = showbal($tla) ;
$acc = trim(explode("💰",$acc)[0]);
if ($acc != "")
	exec_app("php /svn/svnroot/Applications/register.php \"$acc\"");
die();
