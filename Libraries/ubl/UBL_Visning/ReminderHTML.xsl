...
<xsl:stylesheet version="1.0"
        ...
        xmlns:n1   = "urn:oasis:names:specification:ubl:schema:xsd:Reminder-2"
	...
	<xsl:include href="OIOUBL_CommonTemplates2.xsl"/>
	...
	<xsl:template match="n1:Reminder">
		...
		<html>
			...
			<body>
				...
				<table border="0" width="100%" cellspacing="0" cellpadding="2">
					<tr>
						<td colspan="5">
							<!-- indsætter header -->
							<h3>
								<xsl:value-of select="$moduleDoc/module/document-merge/g-funcs/g[@name='OIOUBLRem']"/>&#160;
					...
					<tr>
						<td>
							<!-- indsætter kreditor -->
							<b><xsl:value-of select="$moduleDoc/module/document-merge/g-funcs/g[@name='AccountingSupplierInvrem']"/></b>
							<br/>
					...
					<tr>
						<td>
							<!-- indsætter debitor -->
							<b><xsl:value-of select="$moduleDoc/module/document-merge/g-funcs/g[@name='AccountingCustomerInvrem']"/></b>
							<br/>
					...
					<tr>
						<td width="26%">
							<b><xsl:value-of select="$moduleDoc/module/document-merge/g-funcs/g[@name='ReminderTypeCode']"/>&#160;</b>
							<!-- indsætter Rykkertype -->
							<xsl:value-of select="cbc:ReminderTypeCode"/>
						</td>

						<td width="26%">
							<b><xsl:value-of select="$moduleDoc/module/document-merge/g-funcs/g[@name='ReminderID']"/>&#160;</b>
							<!-- indsætter Rykkernr  -->
						...
						<td width="27%">
							<b><xsl:value-of select="$moduleDoc/module/document-merge/g-funcs/g[@name='ReminderIssueDate']"/>&#160;</b>
                ...
                <hr/>
                <!-- Slut på rykkerhovedet -->


                <!--Start rykkerlinje-->
				<table border="0" width="100%" cellspacing="0" cellpadding="2">
					<!-- [20130102 Added changes according to issue https://bugs.softwareborsen.dk/show_bug.cgi?id=1173]-->
					<tr class="UBLReminderLineHeader">
						<td>
						...
						<td>
							<b><xsl:value-of select="$moduleDoc/module/document-merge/g-funcs/g[@name='DocumentReference']"/></b>
						</td>
						<td width="35%">
							<b><xsl:value-of select="$moduleDoc/module/document-merge/g-funcs/g[@name='SignatureNote']"/></b>
						</td>
						<td align="right">
							<b><xsl:value-of select="$moduleDoc/module/document-merge/g-funcs/g[@name='DebetAmount']"/></b>
						</td>
						<td align="right">
							<b><xsl:value-of select="$moduleDoc/module/document-merge/g-funcs/g[@name='CreditAmount']"/></b>
						</td>
					</tr>
					<xsl:apply-templates select="cac:ReminderLine"/>
				</table>
                <hr/>
                <!--Slut rykkerlinje-->
