...
grep "^# " "$1"|sed s/^#\ //|fzf --tac --multi --header="chose markdown headings to print - PRESS SPACE TO SELECT ALL" --query="!Fakturering !Færdig !Hvidvask !Mapper !Samkøring !Stamdata !Logins" --bind space:select-all|while read heading
do
