...
******************************************************************************************************************
		...
		title= OIOUBL_CommonTemplates3.xml	
...
<xsl:stylesheet version="1.0"
	...
	<xsl:variable name="moduleDoc" select="document('OIOUBL_Headlines3.xml')"/>
	...
	<!--Rykkerlinje herfra -->
		<xsl:template match="cac:ReminderLine">
			<tr class="UBLReminderLine">
				<td>
					<xsl:apply-templates select="cac:BillingReference/cac:InvoiceDocumentReference/cbc:IssueDate"/>
				</td>
				<td class="UBLBillingReferenceID">
					<xsl:apply-templates select="cac:BillingReference/cac:InvoiceDocumentReference/cbc:ID"/>
				</td>
				<td class="UBLUUID">
					<xsl:apply-templates select="cac:BillingReference/cac:InvoiceDocumentReference/cbc:UUID"/>
				</td>
				<td class="UBLDebitLineAmount">
					<xsl:apply-templates select="cbc:DebitLineAmount"/>
				</td>
				<td class="UBLCreditLineAmount" align="right">
					<xsl:apply-templates select="cbc:CreditLineAmount"/>
				</td>
				</tr>
				</xsl:template> <!--
				<td class="UBLInvoiceQuantityUnit">
	...
	<!--Rykkerlinje hertil-->
	<!--Kontoudtoglinje herfra -->
		<xsl:template match="cac:StatementLine">
			<tr class="UBLStatementLine">
				<td>
					<xsl:apply-templates select="cac:BillingReference/cac:InvoiceDocumentReference/cbc:IssueDate"/>
				</td>
				<td class="UBLBillingReferenceID">
...
<!--PaymentMeans herfra-->
	...
	<table>
		...
		<xsl:if test="count(/n1:Reminder/cac:PaymentMeans/cbc:ID) &gt; 1">
			<tr>
				<td>
