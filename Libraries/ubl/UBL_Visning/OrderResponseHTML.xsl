...
******************************************************************************************************************
		...
		title= OrderResponseHTML.xsl
		replaces= OIOUBL_OrderResponse.xsl	
		publisher= "Digitaliseringsstyrelsen"
		Creator= Ole Madsen
		created= 2008-01-15
		modified= 2008-01-22
		issued= 2008-01-22
		conformsTo= UBL-OrderResponse-2.0.xsd
		description= "Stylesheet for displaying a OIOUBL-2.01 OrderResponse"
...
<xsl:stylesheet version="1.0" 
	...
	<xsl:template match="n1:OrderResponse">
		...
		<html>
				...
				<table border="0" width="100%" cellspacing="0" cellpadding="2">
					<tr>
						<td>
							<!-- indsætter header -->
							<h3>
								<xsl:value-of select="$moduleDoc/module/document-merge/g-funcs/g[@name='OIOUBLOrdR']"/>
            ...
            <td width="20%">
              <b>
                <xsl:value-of select="$moduleDoc/module/document-merge/g-funcs/g[@name='TotalPackagesQuantity']"/>&#160;
              </b>
              <!-- indsætter Antal kolli  -->
              <xsl:value-of select="cbc:TotalPackagesQuantity"/>
            </td>
            <td width="20%">
              <b>
                <xsl:value-of select="$moduleDoc/module/document-merge/g-funcs/g[@name='GrossWeightMeasure']"/>&#160;
              </b>
              <!-- indsætter Brutto vægt  -->
              <xsl:value-of select="cbc:GrossWeightMeasure"/>
            </td>
            <td width="20%">
              <b>
                <xsl:value-of select="$moduleDoc/module/document-merge/g-funcs/g[@name='NetWeightMeasure']"/>&#160;
              </b>
              <!-- indsætter Netto vægt  -->
