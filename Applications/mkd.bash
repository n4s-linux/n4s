...
grep "^# " "$1"|sed s/^#\ //|fzf --multi --header="chose markdown headings to print - PRESS SPACE TO SELECT ALL" --query="!Fakturering !Færdig !Hvidvask !Mapper !Samkøring !Stamdata !Pligter !Logins" --bind space:select-all|while read heading
do
